...
Implement the operations of Binary Tree Traversal in serial and parallel (using OpenMP Task). Print the time taken in both the cases. [Solution File](./solution.c)
